...
extern  int16 g_adc0Data[2][2048];   //ADC数据   adc0 1 2 3 采集麦克风信号
extern  int16 g_adc1Data[2][2048];
extern  int16 g_adc2Data[2][2048];
extern  int16 g_adc3Data[2][2048];
// **************************** PIT中断函数 ****************************
...
{
    VoiceGetSample_(g_adc0Data[0],g_adc1Data[0],g_adc2Data[0],g_adc3Data[0]);
